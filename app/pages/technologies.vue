    ...
    <!-- <NavBarExtension>
      <div class="flex flex-col items-center gap-2">
        <SegmentNav
          ...
          :label="breakpoints.smaller('md').value ? 'icon' : 'combination'"
          :padding="breakpoints.smaller('md').value ? undefined : '0 21px'"
          size="small"
          :separator="breakpoints.smaller('md').value ? false : true"
          gray-labels
          :focus="false"
          :outer-padding="3"
