...
!(function (e, n) {
      ...
      return e.reduce((e, p) => {
        ...
        return (
          Array.isArray(h)
            ? (e[p] = {
                data: h.map(e =>
                  'function' == typeof e.serialize ? e.serialize(true, n, d) : e
                ),
              })
            : (e[p] =
      ...
      if (!this._me) {
        ...
        this._me = new Promise(
          ((d = _async_to_generator$15(function* (d, p) {
            ...
            if (_ && !_.ok)
              return n.realm !== e.SKRealm.TV && n._reset(), p('Account error.')
            let m = yield _.json()
  ...
  !(function (e, n, d, p) {
    var h,
      y = arguments.length,
      _ =
        y < 3 ? n : null === p ? (p = Object.getOwnPropertyDescriptor(n, d)) : p
  ...
  class Fullscreen {
    ...
    request(e) {
      ...
      return _async_to_generator$X(function* () {
        if (void 0 !== e)
          return n.stopDispatchingEvents(() => n.requestFullscreenForElement(e))
      })()
    }
        ...
        e.addEventListener(
          ...
          e => {
            this.playbackTargetIsWireless =
              e.target === this._targetElement && !this.playbackTargetIsWireless
          }
        )),
    ...
    class BoxPosition {
      ...
      moveIfOutOfBounds(e, n) {
        switch (n) {
          ...
          case '-y':
            this.bottom > e.bottom &&
              ((this.bottom = e.bottom), (this.top = this.bottom - this.height))
        }
      }
      toCSSCompatValues(e) {
        return {
  ...
  class PreloadingEncryptedSession extends KeySession {
    ...
    handleLicenseJson(e, n, d) {
      ...
      return _async_to_generator$N(function* () {
        ...
        if (!y)
          return void Qe.debug('media key session does not exist, not updating')
  ...
  class QueueItem {
    ...
    constructor(e, n) {
      ...
      _define_property$w(this, 'isAutoplay', true),
        ...
        (this.item = e),
        (this.isAutoplay =
          null !== (d = null == n ? void 0 : n.isAutoplay) && void 0 !== d && d)
    }
  }
  ...
  class Queue {
      ...
      this._isRestricted &&
        ...
        this.isEmpty &&
          this._dispatcher.publish(
            ...
            new MKError(MKError.Reason.CONTENT_RESTRICTED, 'Content restricted')
          ),
    ...
    get unplayedPlayableItems() {
      return toMediaItems(
        this._unplayedQueueItems.filter(e => canPlay(e.item, this.playbackMode))
      )
    }
    get length() {
    ...
    loadNextTracks() {
      ...
      return (function (e) {
        ...
        if ((null == d ? void 0 : d.api) instanceof MediaAPIV3) {
          ...
          n =
            null == h || null === (p = h.data) || void 0 === p ? void 0 : p.data
        } else {
          var h
          const p = {}
          var y
  ...
  class MediaItemPlayback {
    ...
    unmute() {
      this.volume > 0 ||
        ((this.volume = this._volumeAtMute || 1), (this._volumeAtMute = void 0))
    }
