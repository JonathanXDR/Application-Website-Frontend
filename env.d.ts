...
export type CoercedEnvSchema = {
   ...
   * Personal access token that authenticates the server-side GitHub API calls.  
   ...
   * Optional while og:images are prerendered static assets, since no secret is  
   * read at runtime. It becomes required if runtime og:image signing is enabled.  
   * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M29%2022h-5a2.003%202.003%200%200%201-2-2v-6a2%202%200%200%201%202-2h5v2h-5v6h5ZM18%2012h-4V8h-2v14h6a2.003%202.003%200%200%200%202-2v-6a2%202%200%200%200-2-2m-4%208v-6h4v6Zm-6-8H3v2h5v2H4a2%202%200%200%200-2%202v2a2%202%200%200%200%202%202h6v-8a2%202%200%200%200-2-2m0%208H4v-2h4Z%22%2F%3E%3C%2Fsvg%3E)   
   *   
...
type _CoercedEnvSchema_4bf514e3 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_4bf514e3> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_4bf514e3, 'INFISICAL_CLIENT_ID' | 'NUXT_PUBLIC_GITHUB_REPO_NAME' | 'NUXT_PUBLIC_GITHUB_REPO_OWNER' | 'NUXT_PUBLIC_SCRIPTS_GOOGLE_ANALYTICS_ID' | 'NUXT_APPLE_DEVELOPER_KEY_ID' | 'NUXT_APPLE_DEVELOPER_TEAM_ID' | 'NUXT_SITE_NAME' | 'NUXT_SITE_URL' | 'NUXT_PUBLIC_APP_ENVIRONMENT' | 'NODE_ENV' | 'VERCEL' | 'VERCEL_ENV'>> {}
}
...
type _EnvSchemaAsStrings_4bf514e3 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_4bf514e3 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_4bf514e3 {}
  }
}