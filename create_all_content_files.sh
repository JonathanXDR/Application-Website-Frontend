...
# Create all content files for Nuxt Content migration
# Based on nuxt_content_migration_de_→_content_files_config.md
# Excludes content.config.ts as requested

echo "Creating complete content directory structure..."

# Create directory structure
mkdir -p content/de/{pages,site,navigation/{navbar/overview,footer-directory},banners,segments/{theme,projects,technologies},footer/{copyright,legal-links},social,sections,languages,references,fun-facts,technologies,projects}
...
cat > content/de/pages/index.md << 'EOF'
---
title: Übersicht
...
cat > content/de/site/meta.yml << 'EOF'
description: >-
...
cat > content/de/navigation/navbar/01.overview.yml << 'EOF'
id: overview
label: Übersicht
route: "/"
children: []
...
cat > content/de/navigation/navbar/02.technologies.yml << 'EOF'
id: technologies
label: Technologien
route: /technologies
EOF

cat > content/de/navigation/navbar/03.projects.yml << 'EOF'
id: projects
label: Projekte
route: /projects
EOF
...
cat > content/de/navigation/navbar/overview/01.about.yml << 'EOF'
id: about
label: About
route: "/#about"
...
cat > content/de/navigation/navbar/overview/02.languages.yml << 'EOF'
id: languages
label: Sprachen
route: "/#languages"
class: section-separated
...
cat > content/de/navigation/navbar/overview/03.fun-facts.yml << 'EOF'
id: fun-facts
label: Fun Facts
route: "/#funFacts"
class: section-separated
...
cat > content/de/navigation/navbar/overview/04.references.yml << 'EOF'
id: references
label: Referenzen
route: "/#references"
class: section-separated
...
cat > content/de/banners/01.latest-tag.yml << 'EOF'
...
cat > content/de/banners/02.swisscom-projects.yml << 'EOF'
...
cat > content/de/banners/03.technologies.yml << 'EOF'
...
cat > content/de/segments/theme/01.light.yml << 'EOF'
id: light
category: theme
label: Hell
...
cat > content/de/segments/theme/02.dark.yml << 'EOF'
id: dark
category: theme
label: Dunkel
...
cat > content/de/segments/theme/03.auto.yml << 'EOF'
id: auto
category: theme
label: Auto
...
cat > content/de/segments/projects/01.swisscom.yml << 'EOF'
id: swisscom
category: projects
label: Swisscom
...
cat > content/de/segments/projects/02.personal.yml << 'EOF'
id: personal
category: projects
label: Persönlich
...
cat > content/de/segments/projects/03.school.yml << 'EOF'
id: school
category: projects
label: Schule
...
cat > content/de/segments/technologies/01.language.yml << 'EOF'
id: language
...
cat > content/de/segments/technologies/02.library.yml << 'EOF'
id: library
category: technologies
label: Bibliothek
...
cat > content/de/segments/technologies/03.runtime.yml << 'EOF'
id: runtime
category: technologies
label: Runtime
...
cat > content/de/segments/technologies/04.framework.yml << 'EOF'
id: framework
category: technologies
label: Framework
...
cat > content/de/segments/technologies/05.container-management.yml << 'EOF'
...
cat > content/de/segments/technologies/06.orm.yml << 'EOF'
id: orm
category: technologies
label: ORM
icon: { name: sf-symbols:gear }
...
cat > content/de/navigation/footer-directory/01.overview.yml << 'EOF'
id: overview
children:
  - id: overview
    label: Übersicht
...
cat > content/de/navigation/footer-directory/02.advanced.yml << 'EOF'
id: advanced
...
cat > content/de/navigation/footer-directory/03.social.yml << 'EOF'
id: social
...
cat > content/de/footer/copyright/01.links.yml << 'EOF'
links:
  - { title: "Jonathan Russ", url: "https://jonathan-russ.com" }
EOF

cat > content/de/footer/legal-links/01-imprint.yml << 'EOF'
title: Imprint
url: /imprint
EOF

cat > content/de/footer/legal-links/02-privacy.yml << 'EOF'
...
cat > content/de/social/01-mail.yml << 'EOF'
title: Mail
url: "mailto:contact@jonathan-russ.com"
icon: { name: fa6-solid:envelope }
EOF

cat > content/de/social/02-linkedin.yml << 'EOF'
title: LinkedIn
url: "https://linkedin.com/in/jonathan-russ-b7442a228"
icon: { name: fa6-brands:linkedin-in }
EOF

cat > content/de/social/03-github.yml << 'EOF'
title: GitHub
url: "https://github.com/JonathanXDR"
icon: { name: fa6-brands:github }
EOF

cat > content/de/social/04-x.yml << 'EOF'
title: "X (Twitter)"
url: "https://x.com/JonathanXD12_"
icon: { name: fa6-brands:x-twitter }
EOF
...
cat > content/de/sections/about.md << 'EOF'
---
id: about
title: About Me
eyebrow: ''
...
cat > content/de/languages/de.yml << 'EOF'
title: Deutsch
...
cat > content/de/languages/en.yml << 'EOF'
title: Englisch
eyebrow: Fliessend
progress: 60
divider: { direction: left }
...
cat > content/de/languages/fr.yml << 'EOF'
title: Französisch
eyebrow: Gut
progress: 30
divider: { direction: left }
...
cat > content/de/references/01-patrice-stampfli.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
...
cat > content/de/references/02-steve-hess.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
...
cat > content/de/references/03-nick-zimmermann.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
...
cat > content/de/references/04-alessio-iantosca.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
eyebrow: Ehemaliger Projektanbieter
...
cat > content/de/references/05-carlo-schmid.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
eyebrow: Ehemaliger Projektanbieter
title: Carlo Schmid
...
cat > content/de/references/06-kim-eggler.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
...
cat > content/de/references/07-micha-humbel.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
...
cat > content/de/references/08-radu-margineanu.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
eyebrow: Ehemaliger Projektanbieter
...
cat > content/de/references/09-oliver-kramer.yml << 'EOF'
icon: { name: sf-symbols:person.fill }
eyebrow: Ehemaliger Projektanbieter
title: Oliver Kramer
...
cat > content/de/fun-facts/01-travelled-km.yml << 'EOF'
progress: 100000
description: Zurückgelegte Kilometer
EOF

cat > content/de/fun-facts/02-work-hours.yml << 'EOF'
progress: 10000
description: Geleistete Arbeitsstunden
EOF

cat > content/de/fun-facts/03-git-commits.yml << 'EOF'
progress: 15000
description: Git commits
EOF

cat > content/de/fun-facts/04-lines-of-code.yml << 'EOF'
progress: 1000000
description: Geschriebene Codezeilen
EOF

cat > content/de/fun-facts/05-debug-hours.yml << 'EOF'
progress: 1000
description: Investierte Stunden ins Debugging
EOF

cat > content/de/fun-facts/06-bugs-fixed.yml << 'EOF'
progress: 2000
description: Gefixte Bugs
EOF

cat > content/de/fun-facts/07-coffee-cups.yml << 'EOF'
progress: 2400
description: Getrunkene Tassen Kaffee
EOF

cat > content/de/fun-facts/08-music-hours.yml << 'EOF'
progress: 7200
description: Gehörte Stunden Musik
EOF

# ============================================================
# TECHNOLOGIES (all technologies from the guide)
# ============================================================

cat > content/de/technologies/html.yml << 'EOF'
icon:
...
cat > content/de/technologies/css.yml << 'EOF'
icon:
...
cat > content/de/technologies/javascript.yml << 'EOF'
icon:
...
cat > content/de/technologies/sdx.yml << 'EOF'
icon:
...
cat > content/de/technologies/nodejs.yml << 'EOF'
icon:
...
cat > content/de/technologies/sql.yml << 'EOF'
icon:
...
cat > content/de/technologies/express.yml << 'EOF'
icon:
...
cat > content/de/technologies/vue.yml << 'EOF'
icon:
...
cat > content/de/technologies/typescript.yml << 'EOF'
icon:
...
cat > content/de/technologies/csharp.yml << 'EOF'
icon:
...
cat > content/de/technologies/java.yml << 'EOF'
icon:
...
cat > content/de/technologies/bash.yml << 'EOF'
icon:
...
cat > content/de/technologies/react.yml << 'EOF'
icon:
...
cat > content/de/technologies/nextjs.yml << 'EOF'
icon:
...
cat > content/de/technologies/docker.yml << 'EOF'
icon:
...
cat > content/de/technologies/kubernetes.yml << 'EOF'
icon:
...
cat > content/de/technologies/nestjs.yml << 'EOF'
icon:
...
cat > content/de/technologies/prisma.yml << 'EOF'
icon:
...
cat > content/de/technologies/typeorm.yml << 'EOF'
icon:
...
cat > content/de/technologies/github-primer.yml << 'EOF'
icon:
...
cat > content/de/technologies/tailwindcss.yml << 'EOF'
icon:
...
cat > content/de/technologies/python.yml << 'EOF'
icon:
...
cat > content/de/technologies/kotlin.yml << 'EOF'
icon:
...
cat > content/de/technologies/jetpack-compose.yml << 'EOF'
icon:
...
cat > content/de/technologies/material-design-3.yml << 'EOF'
icon:
...
cat > content/de/technologies/nuxt.yml << 'EOF'
icon:
...
cat > content/de/technologies/angular.yml << 'EOF'
icon:
...
cat > content/de/technologies/bun.yml << 'EOF'
icon:
...
cat > content/de/technologies/scala.yml << 'EOF'
icon:
...
# ============================================================
# PROJECTS (all projects from the guide)
# ============================================================

cat > content/de/projects/01-nex-first-steps.yml << 'EOF'
...
cat > content/de/projects/02-nexcc.yml << 'EOF'
...
cat > content/de/projects/03-banking-automation.yml << 'EOF'
...
cat > content/de/projects/04-apps-frontend.yml << 'EOF'
...
cat > content/de/projects/05-apps-backend.yml << 'EOF'
icon: { name: sf-symbols:gear }
eyebrow: Backend
title: Apps Team
description: >-
...
cat > content/de/projects/06-security-art.yml << 'EOF'
...
cat > content/de/projects/07-piz-tofana.yml << 'EOF'
icon: { name: sf-symbols:shield.lefthalf.filled }
eyebrow: "Security Journey"
...
cat > content/de/projects/08-apps-ipa.yml << 'EOF'
...
echo ""
echo "📊 Summary:"
echo "   - Created complete directory structure under content/de/"
echo "   - Generated all page content (index.md)"
echo "   - Created site metadata"
echo "   - Built navigation structure (navbar + footer directory)"
echo "   - Added banners with dynamic variables"
echo "   - Created theme/project/technology segments"
echo "   - Generated footer links and social media"
echo "   - Added about section with markdown content"
echo "   - Created language skills data"
echo "   - Generated all reference contacts"
echo "   - Added fun facts with progress data"
echo "   - Created comprehensive technology portfolio"
echo "   - Generated complete project timeline"
echo ""
echo "🎯 Ready for Nuxt Content v3 integration!"
echo "   Next: Query this content using queryCollection() in your components"
echo "   Multi-language: Copy content/de/ to content/en/ and translate"