...
export type GetOwnerGists = Endpoints['GET /gists']['response']['data']

export type GetOwnerGist = GetOwnerGists[number]

export type GetOwnerGistParameters = Endpoints['GET /gists']['parameters']
