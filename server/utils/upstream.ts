...
// or rate limited. Those collapse to gateway errors (429 -> 503 Service
// Unavailable, everything else -> 502 Bad Gateway). The fixed statusText keeps
// upstream detail out of the public response. The caller logs the real status.
