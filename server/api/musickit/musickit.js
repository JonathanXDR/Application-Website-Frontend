...
!(function (e, n) {
  ...
  class Logger$1 {
    ...
    createChild(e, n) {
      ...
      return void 0 !== d
        ...
        : new Logger$1(
            e,
            _object_spread_props$z(_object_spread$U({}, n), { parent: this }),
          );
    }
    linkChild(e) {
    ...
    logRecord(e) {
      ...
      const n = _object_spread$U({ namespace: this.namespace }, e);
  ...
  const {
    ...
    H = {
      [x]: { allowed: [j], unknown: [U, B, F, V, G] },
      [j]: { allowed: [L, F, V, G], unknown: [] },
      [L]: { allowed: [N], unknown: [V] },
      [N]: { allowed: [U, V], unknown: [B, F, G] },
      [U]: { allowed: [], unknown: [] },
      [B]: { allowed: [], unknown: [] },
      [F]: { allowed: [], unknown: [] },
      [V]: { allowed: [], unknown: [] },
  ...
  class DataStore extends Notifications {
    ...
    populateDataRecord(e, n = {}, d) {
      ...
      const y = this._materializeRecord(
        n,
        _object_spread$S({ id: e.id, type: e.type }, d),
      );
      return (
  ...
  const he = {
    ...
    engine: [
      [
        ...
        (e) => _object_spread$O({ name: "blink" }, parseVersion(e[1])),
      ],
      [
        /windows.+ edge\/([\w\.]+)/i,
        (e) => _object_spread$O({ name: "blink" }, parseVersion(e[1])),
      ...
      [
        /presto\/([\w\.]+)/i,
        (e) => _object_spread$O({ name: "presto" }, parseVersion(e[2])),
      ],
      [
        /trident\/([\w\.]+)/i,
        (e) => _object_spread$O({ name: "trident" }, parseVersion(e[1])),
      ],
      [
        /gecko\/([\w\.]+)/i,
        (e) => _object_spread$O({ name: "gecko" }, parseVersion(e[1])),
      ],
      [
        /(khtml|netfront|netsurf|amaya|lynx|w3m|goanna)\/([\w\.]+)/i,
        (e) => _object_spread$O({ name: "other" }, parseVersion(e[2])),
      ],
      [
        /webkit\/([\w\.]+)/i,
        (e) => _object_spread$O({ name: "webkit" }, parseVersion(e[1])),
      ],
    ],
    os: [
      [
        ...
        (e) => _object_spread$O({ name: "windows" }, parseVersion(e[1])),
      ],
      [
      ...
      [
        /cros [\w]+(?:\)| ([\w\.]+)\b)/i,
        (e) => _object_spread$O({ name: "chromeos" }, parseVersion(e[1])),
      ],
      [
        /(?:android|webos|qnx|bada|rim tablet os|maemo|meego|sailfish)[-\/ ]?([\w\.]*)/i,
        /droid ([\w\.]+|[\d+])\b.+(android[- ]x86|harmonyos)/i,
        (e) => _object_spread$O({ name: "android" }, parseVersion(e[1])),
      ],
      [/linux/i, () => ({ name: "linux" })],
    ],
  };
  ...
  class Logger {
    ...
    createChild(e, n) {
      ...
      return void 0 !== d
        ...
        : new Logger(
            e,
            _object_spread_props$t(_object_spread$L({}, n), { parent: this }),
          );
    }
    linkChild(e) {
      if (void 0 !== e.parent && e.parent !== this)
    ...
    logRecord(e) {
      if (!this.levelPolicy(this.level, e.level)) return;
      const n = _object_spread$L({ namespace: this.namespace }, e);
      for (const d of Object.values(this.handlers)) d.process(n);
    }
    error(e, ...n) {
  ...
  const Ne = {
    ...
    Ue = { [e.SKRealm.TV]: "pltvcid", [e.SKRealm.MUSIC]: "pldfltcid" };
    ...
    handleRequest(e) {
      ...
      return ((n = function* () {
        ...
        try {
          ...
          return Object.assign(n, {
            error: { code: V.code || -32603, message: V.message },
          });
        }
      }),
      function () {
  ...
  class StoreKit extends Notifications {
    ...
    requestUserToken() {
      ...
      return _async_to_generator$15(function* () {
        ...
        try {
          const n = yield e._serviceSetupView.load({ action: He.AUTHORIZE });
          (e.cid = n.cid),
            ...
            const e = [
                {
                  ...
                  audioCapabilities: [{ contentType: ct }],
                },
              ],
  ...
  class BitrateCalculator {
    ...
    set bitrate(e) {
      this._bitrate !== e &&
        ((this._bitrate = e),
        this._dispatcher.publish(Pt.playbackBitrateDidChange, { bitrate: e }));
    }
  ...
  ***************************************************************************** */
      ...
      return _async_to_generator$Y(function* () {
        yield p._addToTimeline(
          _object_spread_props$i(
            ...
            { eventType: jt.PLAY_END, endReasonType: d, position: n },
          ),
        );
      })();
    }
  ...
  class BasePlayer {
    ...
    set playbackTargetIsWireless(e) {
      e !== this._playbackTargetIsWireless &&
        ...
        this._dispatcher.publish(Oi, { playing: e }));
    }
    get volume() {
    ...
    pipEventHandler(n) {
      switch (n.type) {
        ...
        case "leavepictureinpicture":
          this._dispatcher.publish(on, { mode: e.PresentationMode.inline });
          break;
      ...
      return _async_to_generator$M(function* () {
        ...
        if (
          ...
          (e._session = new MSSession()),
            e._session.attachMedia(p, { keySystem: ot.PLAYREADY });
  ...
  class Manifest extends Notifications {
    ...
    _detectKeyTags() {
      ...
      e.length &&
        this.dispatchEvent(Sn.keysParsed, { item: this.mediaItem, keys: e });
    }
    get _legacyKeys() {
      const e = this._data.match(Tn);
      Qe.debug("manifest: EXT_X_KEY_URI matches", e);
  ...
  class HlsJsVideoPlayer extends VideoPlayer {
    ...
    playHlsStream(e, n, d = {}) {
      ...
      return _async_to_generator$B(function* () {
        ...
        const m = {
            ...
            appData: { serviceName: at.app.name },
          },
    ...
    createHlsPlayer() {
      ...
      const { _keySystem: n } = this,
        ...
        y = { disableAudioCodecList: new Set([7, 6, 3, 5, 4]) },
        _ = (function (e) {
          for (var n = 1; n < arguments.length; n++) {
            var d = null != arguments[n] ? arguments[n] : {},
              p = Object.keys(d);
  ...
  class PlaybackController {
    ...
    _dataForQueueOptions(e) {
      ...
      return _async_to_generator$s(function* () {
        ...
        return _object_spread_props$a(_object_spread$g({}, e), { context: d });
      })();
    }
  ...
  const Uo = { music: { url: "https://api.music.apple.com" } };
  class MediaAPIV3 {
  ...
  class ContinuousPlaybackController extends PlaybackController {
    ...
    get context() {
      return (function (e) {
        ...
        return e;
      })({ featureName: St.STATION }, this._context);
    }
    get isLive() {
      return this._isLive;
    }
  ...
  function extractAssetsFromMasterManifest(e, n, d) {
    ...
    for (; (h = p.exec(e)); ) {
      ...
      /^http(s)?:\/\//.test(e) ||
        ...
        d.assets.push({ bandwidth: Number(P), codec: b, URL: e });
    }
  }
  ...
  const oa = { keySystemGenericError: "keySystemGenericError" },
            ...
            : (function (e) {
              ...
              : (((e) => {
                  if (!supportsDrm()) {
                    ...
                    throw (
                      ((n.data = { item: e }), it.warn("No DRM detected"), n)
                    );
                  }
                })(e),
    ...
    _playPreview(n, d) {
      ...
      return _async_to_generator$8(function* () {
        ...
        const h = p._currentPlayer,
          y = h.isPaused() && !d;
        return (
          supportsDrm() || h.dispatch(Pt.drmUnsupported, { item: n }),
    ...
    configure(e) {
      ...
      return _async_to_generator$4(function* () {
        ...
        (n.instance = e.instance),
          ...
          (n._activityTracker =
            ((d = e.instance),
            (p = { runtime: e.services.runtime, request: e.services.request }),
            new PlayActivity(
              d.developerToken,
              d.musicUserToken,
        ...
        (function (e, n) {
          ...
          return {
            container: cleanContainer(
              _object_spread$1({}, m, null !== _ ? { name: _ } : {}),
            ),
          };
        })(n, p),
      ),
      ...
      return _async_to_generator$2(function* () {
        if (d._isPlaybackSupported())
          return d._playbackController.queue
            ? (d.deferPlayback(),
              d._playbackController.prependToQueue(e, { clear: n }))
            : d.setQueue(e);
