...
.reduced.button {
  --sk-button-padding-horizontal: 11px !important;
  --sk-button-padding-vertical: 4px !important;
  --sk-button-min-width-basis: 45px !important;
...
.symptoms-category .content-area .support-section button {
  margin-top: 0;
}
