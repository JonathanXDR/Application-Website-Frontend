...
.with-paddlenav .rc-ribbon-content-autoscroll:before {
  left: 0;
  background-image: linear-gradient(90deg, var(--color-fill-tertiary) 16px, hsla(0, 0%, 100%, 0));
}
@media only screen and (max-width: 1023px) and (max-device-width: 736px) {
  .with-paddlenav .rc-ribbon-content-autoscroll:before {
    background-image: linear-gradient(90deg, var(--color-fill-tertiary), hsla(0, 0%, 100%, 0));
  }
}
.with-paddlenav .rc-ribbon-content-autoscroll:after {
  right: 0;
  background-image: linear-gradient(270deg, var(--color-fill-tertiary) 16px, hsla(0, 0%, 100%, 0));
}
@media only screen and (max-width: 1023px) and (max-device-width: 736px) {
  .with-paddlenav .rc-ribbon-content-autoscroll:after {
    background-image: linear-gradient(270deg, var(--color-fill-tertiary), hsla(0, 0%, 100%, 0));
  }
}
